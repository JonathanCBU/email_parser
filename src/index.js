...
var main = function () { return __awaiter(_this, void 0, void 0, function () {
    var lock, message, _a, _b, _c, message_1, e_1_1;
    var _d, e_1, _e, _f;
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, client.fetchOne(client.mailbox.exists, { source: true })];
            case 4:
                message = _g.sent();
            ...
            case 5:
                ...
                _a = true, _b = __asyncValues(client.fetch('1:*', { envelope: true }));
                _g.label = 6;
            ...
            case 7:
                ...
                _a = false;
                message_1 = _f;
                console.log("".concat(message_1.uid, ": ").concat(message_1.envelope.subject));
                _g.label = 8;
            case 8:
                _a = true;
                return [3 /*break*/, 6];
